...
const ResumeOne = () => {
    ...
    const [memeOneName, setMemeOneName] = useState(formDetailsObj.firstName + formDetailsObj.lastName);
    const [memeTwoNumber, setMemeTwoNumber] = useState(formDetailsObj.phoneNum);
    const [memeThreeEmail, setMemeThreeEmail] = useState(formDetailsObj.email);
    const [memeFourAddress, setMemeFourAddress] = useState(formDetailsObj.address);
            ...
            <Box sx={resumeOneStyles.mainContainer}>
                ...
                <Box sx={resumeOneStyles.childContainer}>
                    <Box sx={resumeOneStyles.nameContainer}>
                        <Typography sx={resumeOneStyles.nameText}>{`${formDetailsObj.firstName} ${formDetailsObj.lastName} ${"   "}`}Candidate</Typography>
                        <Typography sx={resumeOneStyles.designationText}>Human Resource Manager</Typography>
                        <Typography sx={resumeOneStyles.addressText}>{formDetailsObj.address}</Typography>
                    </Box>
                    <Box sx={resumeOneStyles.numberEmailContainer} >
                        <Typography sx={resumeOneStyles.number}>{formDetailsObj.phoneNum}</Typography>
                        <Typography sx={resumeOneStyles.email}><Box component="span" sx={resumeOneStyles.emailSpan}>{formDetailsObj.email}</Box></Typography>
                    </Box>
